...
from Logic.operatiuni import mutare_obiect_locatie, concatenare, ordonare_crescator_pret
from UI.consola import show_all, ui_pret_max_locatie, ui_suma_pret_locatie
