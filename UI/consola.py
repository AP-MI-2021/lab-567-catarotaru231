...
from Logic.operatiuni import concatenare, mutare_obiect_locatie, pret_max_locatie, ordonare_crescator_pret, \
    suma_pret_locatie
...
def run_menu(lista):
    ...
    while True:
        ...
        if optiune == "1":
            ...
            lista = ui_mutare_obiect_locatie(lista, undo_list, redo_list)
        elif optiune == "5":
            lista = ui_concatenare(lista, undo_list, redo_list)
        elif optiune == "6":
            ui_pret_max_locatie(lista)
        elif optiune == "7":
            lista = ui_ordonare_crescator_pret(lista, undo_list, redo_list)
        elif optiune == "8":
